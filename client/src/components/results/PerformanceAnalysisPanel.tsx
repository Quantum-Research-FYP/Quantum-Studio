  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', gap: '24px', marginBottom: '24px', flexWrap: 'wrap' }}>
        ...
        >
          ...
          <div style={{ fontSize: '0.75rem', color: '#71717a', marginTop: '4px' }}>
            Overlap with ideal statevector
          </div>
        </div>
        ...
        >
          ...
          <div style={{ fontSize: '1.8rem', fontWeight: 700, color: '#3b82f6' }}>
            {Number(data.metadata.durationMs) || 0} ms
          </div>
          <div style={{ fontSize: '0.75rem', color: '#71717a', marginTop: '4px' }}>
            Backend: {String(data.metadata.backend)}
          </div>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', gap: '24px', flexWrap: 'wrap' }}>
        ...
        >
          <h3 style={{ fontSize: '0.9rem', color: '#e4e4e7', marginBottom: '16px' }}>
            Estimated Error Budget Breakdown
          </h3>
        ...
        >
          <h3 style={{ fontSize: '0.9rem', color: '#e4e4e7', marginBottom: '16px' }}>
            Fidelity Decay (Monte Carlo Noise Scaling)
          </h3>
          <div style={{ height: '300px' }}>
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={data.monteCarloFidelity}>
                ...
                <RechartsTooltip
                  ...
                  labelFormatter={(val) => `Noise Scale: ${val}x`}
                />
                <Legend />
                <Line
                  type="monotone"
        ...
        >
          <h3 style={{ fontSize: '0.9rem', color: '#e4e4e7', marginBottom: '16px' }}>
            Probability Distribution (Ideal vs Noisy)
          </h3>
